...
export default function AgeGroupBar({ data, currency = 'USD' }: Props) {
  return (
    <div className="card h-full">
      <div className="card-title">Faixas etárias por gasto</div>
      <div className="h-[230px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 10, right: 8, left: 0, bottom: 0 }}>
            ...
            <Bar dataKey="female" name="Feminino" fill="#D44A8A" radius={[4, 4, 0, 0]}>
            ...
            <Bar dataKey="male"   name="Masculino"   fill="#F4B2CD" radius={[4, 4, 0, 0]}>
