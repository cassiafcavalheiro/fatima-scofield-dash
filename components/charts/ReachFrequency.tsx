...
export default function ReachFrequency({ data }: Props) {
  ...
  return (
    <div className="card h-full">
      <div className="card-title">Alcance e Frequência</div>
      <div className="h-[230px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 10, right: 6, left: 0, bottom: 0 }} barCategoryGap="20%">
            ...
            <Bar yAxisId="left" dataKey="reach" name="Alcance" radius={[3, 3, 0, 0]}>
              {data.map((d, i) => (
            ...
            <Bar yAxisId="right" dataKey="frequency" name="Frequência" radius={[3, 3, 0, 0]}>
              {data.map((d, i) => (
