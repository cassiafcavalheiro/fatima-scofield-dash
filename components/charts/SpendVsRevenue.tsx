...
import type { DualSeriesPoint } from '@/lib/types';
...
export default function SpendVsRevenue({ data, currency = 'USD' }: { data: DualSeriesPoint[]; currency?: string }) {
  ...
  return (
    <div className="card h-full">
      <div className="card-title">Valor gasto e Valor de compras</div>
      <div className="h-[260px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 10, right: 6, left: 0, bottom: 0 }} barCategoryGap="20%">
            ...
            <Bar dataKey="spend" name="Valor gasto" radius={[3, 3, 0, 0]}>
              {data.map((d, i) => (
            ...
            <Bar dataKey="revenue" name="Valor de compras" radius={[3, 3, 0, 0]}>
              {data.map((d, i) => (
